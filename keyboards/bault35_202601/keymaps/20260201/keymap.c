...
//JP for Windows(jp layout keyboard setting)
  ...
  [JSYM2] = LAYOUT(
    ...
    JP_QUOT,JP_DQUO,JP_MINS,JP_LCBR,JP_RCBR,CM_SF10,CM_CAPS,CM_JHNZ,_______,_______,
  ...
  [USYM2] = LAYOUT( /* Qwerty 101 uskey */
    ...
    KC_QUOT,KC_DQUO,KC_MINS,KC_LCBR,KC_RCBR,CM_SF10,CM_CAPS,CM_UHNZ,_______,_______,
