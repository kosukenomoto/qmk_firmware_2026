...
//JP for Windows(jp layout keyboard setting)
  ...
  [JSYM] = LAYOUT_60_hhkb(
    ...
    _______,JP_BSLS,JP_AMPR,JP_PIPE,JP_TILD,JP_GRV, _______,JP_ZKHK,_______,KC_CAPS,_______,_______,_______,
    _______,_______,_______,_______,_______),
  ...
  [USYM] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    ...
    _______,KC_BSLS,KC_AMPR,KC_PIPE,KC_TILD,KC_GRV, _______,CM_UHNZ,_______,KC_CAPS,_______,_______,_______,
    _______,_______,_______,_______,_______),
  ...
  [FN] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
  ...
  [SYS] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
  ...
  [ALTTAB] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,CM_STAB,KC_TAB, _______,_______,_______,KC_UP,  _______,_______,_______,_______,_______,
