...
//JP for Windows(jp layout keyboard setting)
  ...
  [JSYM] = LAYOUT_60_hhkb(
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,JP_EXLM,JP_AT,  JP_HASH,JP_DLR, JP_PERC,_______,JP_AMPR,JP_PIPE,MO_JSM2,_______,_______,_______,_______,
    _______,JP_LBRC,JP_RBRC,JP_LPRN,JP_RPRN,JP_CIRC,JP_TILD,JP_MINS,JP_ASTR,JP_ZKHK,_______,_______,_______,
    _______,JP_BSLS,JP_UNDS,JP_LCBR,JP_RCBR,JP_GRV, JP_EQL ,JP_PLUS,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______),

  [USYM] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,_______,KC_AMPR,KC_PIPE,MO_USM2,_______,_______,_______,_______,
    _______,KC_LBRC,KC_RBRC,KC_LPRN,KC_RPRN,KC_CIRC,KC_TILD,KC_MINS,KC_ASTR,CM_UHNZ,_______,_______,_______,
    _______,KC_BSLS,KC_UNDS,KC_LCBR,KC_RCBR,KC_GRV, KC_EQL ,KC_PLUS,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______),

  [JSYM2] = LAYOUT_60_hhkb(
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,JP_7   ,JP_8   ,JP_9   ,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,JP_4   ,JP_5   ,JP_6   ,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,JP_0   ,JP_1   ,JP_2   ,JP_3   ,JP_SLSH,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______),
  ...
  [USYM2] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    ...
    _______,KC_0   ,KC_1   ,KC_2   ,KC_3   ,KC_SLSH,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______),

  [JSPFN] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    _______,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12 ,_______,_______,
    CM_GUID,CM_GUIE,CM_ALT4,LT_EXCL,SW_ATAB,CM_WSCS,CM_STAB,KC_HOME,KC_UP,  KC_END, KC_TAB, KC_BTN1,_______,_______,
    _______,KC_LALT,KC_LSFT,KC_DEL, MO_HYPS,KC_LGUI,KC_BSPC,KC_LEFT,KC_DOWN,KC_RGHT,KC_ENT, CM_SF10,_______,
  ...
  [UFN] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    ...
    _______,_______,_______,_______,_______),
    // _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    // CM_GUID,KC_PGUP,KC_HOME,KC_UP,  KC_END, CM_WSCS,_______,_______,CM_UHNZ,KC_LGUI,_______,_______,_______,_______,
    // _______,KC_PGDN,KC_LEFT,KC_DOWN,KC_RGHT,KC_COLN,KC_BSPC,KC_ENT, MO_HYPS,CM_UHNZ,_______,_______,_______,
    // _______,CM_GUIE,CM_ALT4,KC_DEL, _______,_______,_______,SW_ATAB,_______,_______,_______,_______,_______,
    // _______,_______,_______,_______,_______),
  ...
  [JFN] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    ...
    _______,_______,_______,_______,_______),
    // _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    // CM_GUID,KC_PGUP,KC_HOME,KC_UP,  KC_END, CM_WSCS,_______,_______,JP_ZKHK,KC_LGUI,_______,_______,_______,_______,
    // _______,KC_PGDN,KC_LEFT,KC_DOWN,KC_RGHT,JP_COLN,KC_BSPC,KC_ENT, MO_HYPS,JP_ZKHK,_______,_______,_______,
    // _______,CM_GUIE,CM_ALT4,KC_DEL, _______,_______,_______,SW_ATAB,_______,_______,_______,_______,_______,
    // _______,_______,_______,_______,_______),
  ...
  [ALTTAB] = LAYOUT_60_hhkb( /* Qwerty 101 uskey */
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,KC_UP,  KC_TAB, _______,_______,_______,KC_UP,  _______,_______,_______,_______,_______,
    _______,_______,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,_______,
    _______,_______,_______,_______,_______,_______,CM_STAB,KC_TAB, _______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______)
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case CM_FNCM:
      if (get_highest_layer(default_layer_state)==JBASE){
        user_lt(record,JSYM2,JP_SLSH,&fncm_pressed,&fncm_pressed_time,false,&mod_switch_keycode);
      } else {
        user_lt(record,USYM2,KC_SLSH,&fncm_pressed,&fncm_pressed_time,false,&mod_switch_keycode);
      }
      return false;
      break;
    case SW_LSFT:
